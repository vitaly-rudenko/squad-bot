...
export const MiniReceiptHeader: FC<{
  ...
  return <div className="flex flex-row gap-3 py-1 h-12 items-center border rounded-md m-1">
    <div className="pl-3 flex flex-row gap-3 items-center grow cursor-pointer h-full"
      onClick={onEdit}>
